...
namespace Dev2.Activities.Designers.Tests.Core.Database
{
    ...
    public class DatabaseInputRegionTest
    {
        ...
        [Category("DatabaseInputRegion_Constructor")]
        ...
        [Test]
        [Author("Pieter Terblanche")]
        [Category("DatabaseInputRegion_TestClone")]
        ...
        [Test]
        [Author("Pieter Terblanche")]
        [Category("DatabaseInputRegion_Test")]
        ...
        [Test]
        [Author("Pieter Terblanche")]
        [Category("DatabaseInputRegion_RestoreFromPrevious")]
        ...
        [Test]
        [Author("Pieter Terblanche")]
        [Category("DatabaseInputRegion_SourceChanged")]
