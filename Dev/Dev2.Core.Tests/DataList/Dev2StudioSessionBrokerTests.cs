...
namespace Dev2.Tests.DataList
{
    ...
    public class Dev2StudioSessionBrokerTests
    {
        ...
        [Category(nameof(Dev2StudioSessionBroker))]
        public void Dev2StudioSessionBroker_InitSessionWithNoDataBaseDirectoryIsNull()
        {
            ...
            NUnit.Framework.Assert.IsTrue(rootFolder.Contains(to.BaseSaveDirectory));
        ...
        public void Dev2StudioSessionBroker_InitSessionWithNoDataBaseDirectoryIsNullStillInitialises()
        {
            ...
            NUnit.Framework.Assert.AreEqual(string.Empty, to.Error);
            NUnit.Framework.Assert.IsNotNull(to.BinaryDataList);
        ...
        public void Dev2StudioSessionBroker_InitSessionWithSingleScalar()
        {
            ...
            NUnit.Framework.Assert.AreEqual(string.Empty, to.Error);
            NUnit.Framework.Assert.AreEqual(expected, to.XmlData, "Got  [ " + to.XmlData + "] , but expected [ " + expected + " ]");
        ...
        public void Dev2StudioSessionBroker_PersistSessionWithSavedData_ExpectSavedData()
        {
            ...
            NUnit.Framework.Assert.AreEqual("<DataList><scalar1>s1</scalar1><rs><f1>f1Value</f1><f2>f2Value</f2></rs></DataList>", to.XmlData);
        ...
        public void Dev2StudioSessionBrokerNotPersistSessionWithSavedData_ExpectEmptyDataList()
        {
            ...
            NUnit.Framework.Assert.AreEqual("<DataList></DataList>", to.XmlData);
