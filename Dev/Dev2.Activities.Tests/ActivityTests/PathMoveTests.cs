...
#pragma warning restore 649
        ...
        [Category("DsfPathMove_UpdateForEachInputs")]
        ...
        [Test]
        [Author("Hagashen Naidu")]
        [Category("DsfPathMove_UpdateForEachOutputs")]
        public void DsfPathMove_UpdateForEachOutputs_NullUpdates_DoesNothing()
        {
            //------------Setup for test--------------------------
            var newGuid = Guid.NewGuid();
            const string result = "[[CompanyName]]";
            var act = new DsfPathMove { InputPath = string.Concat(Environment.CurrentDirectory, "\\", newGuid + "[[CompanyName]].txt"), OutputPath = string.Concat(Environment.CurrentDirectory, "\\", newGuid + "[[CompanyName]]2.txt"), Result = result };
        ...
        [Test]
        [Author("Hagashen Naidu")]
        [Category("DsfPathMove_GetForEachInputs")]
        ...
        [Test]
        [Author("Hagashen Naidu")]
        [Category("DsfPathMove_GetForEachOutputs")]
        ...
        public void Move_Execute_Workflow_SourceFile_And_DestinationFile_Has_Separate_Passwords_Both_Passwords_Are_Sent_To_OperationBroker()
        {
            ...
            {
                Path.Combine(Environment.CurrentDirectory, "NewFileFolder\\Dev2.txt")
            };

            var directoryNames = new List<string>();
            directoryNames.Add(Path.Combine(Environment.CurrentDirectory, "NewFileFolder"));
            directoryNames.Add(Path.Combine(Environment.CurrentDirectory, "NewFileFolder2"));
        ...
        [Test]
        [Author("Tshepo Ntlhokoa")]
        [Category("DsfPathMove_Construct")]
