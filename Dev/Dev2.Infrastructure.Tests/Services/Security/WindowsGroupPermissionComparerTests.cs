...
namespace Dev2.Infrastructure.Tests.Services.Security
{
    ...
    public class WindowsGroupPermissionComparerTests
    {
        ...
        [NUnit.Framework.Category("WindowsGroupPermissionComparer_Constructor")]
        ...
        [Test]
        [Author("Trevor Williams-Ros")]
        [NUnit.Framework.Category("WindowsGroupPermissionComparer_Compare")]
        ...
        [NUnit.Framework.Category("WindowsGroupPermissionComparer_Compare")] //This is to ensure that Public comes after administrators
