...
namespace WarewolfParsingTest
{
    ...
    public class EvalFunctionTests
    {
        ...
        public void Eval_Scalar()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res),  "1" );
        }
        [Test]
        [Author("Leon Rajindrapersadh")]
        [Category("Eval")]
        public void Eval_RecSet()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res),  "3" );
        }
        ...
        public void Eval_RecSetIndexExpression()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res), "1,a");
        }
        [Test]
        [Author("Leon Rajindrapersadh")]
        [Category("Eval")]
        ...
        public void Eval_Indexes()  
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(res, 1);
        }
        ...
        public void Eval_RecSet_Star()
        {
            ...
            var res = EvaluationFunctions.eval(env, 0, false,  "[[Rec(*).a]]" );
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res),  "1,2,3" );
        }
        ...
        public void Eval_RecSet_AsString()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.atomtoString(res), "123");
        }
        [Test]
        [Author("Leon Rajindrapersadh")]
        [Category("Eval")]
        public void Eval_RecSet_AsStringind()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.atomtoString(res), "1");
        }
        ...
        public void Eval_RecSet_Complete()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res), "1,2,3,a,b,c");
        }
        ...
        public void Eval_RecSet_Complete_WithUpdate()
        {
            ...
            NUnit.Framework.Assert.AreEqual("11,1a,a1,aa", CommonFunctions.evalResultToString(res));
        }
        [Test]
        [Author("Leon Rajindrapersadh")]
        [Category("Eval")]
        public void Eval_RecSet_Complete_WithUpdate_Mixed()
        {
            ...
            //------------Assert Results-------------------------
            // note this is currently undefined behaviour
            NUnit.Framework.Assert.AreEqual("13,1c,a3,ac", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_RecSet_Complete_WithUpdate_Recset()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res), "11");
        }
        ...
        public void Eval_RecSet_Complete_WithUpdate_Recset_Mixed()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res), "13");
        }
        ...
        public void Eval_RecSet_Complex()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("11,21,31",  CommonFunctions.evalResultToString(res) );
        }
        ...
        public void Eval_RecSet_Json()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res),  "22" );
        }
        ...
        public void Eval_RecSet_Json_Array()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res),  "2" );
        }
        ...
        public void Eval_RecSet_Json_Array_star()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res),  "2,3" );
        }
        ...
        public void Eval_RecSet_RecsetResult()
        {
            ...
            var res = EvaluationFunctions.eval(env, 0, false,  " [[Rec()]]" );
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(" 3, c",  CommonFunctions.evalResultToString(res) );
        }
        ...
        public void Eval_PositionsRecSet_Complete()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res), "3,c");
        }
        [Test]
        [Author("Leon Rajindrapersadh")]
        [Category("Eval")]
        ...
        public void Eval_PositionsRecSet_Complex()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(CommonFunctions.evalResultToString(res), "1,2,31");
        }
        ...
        public void Eval_evalIndexes_IndexesValid()
        {
            ...
            NUnit.Framework.Assert.AreEqual(enumerable.ToArray()[1], 2);
            NUnit.Framework.Assert.AreEqual(enumerable.ToArray()[2], 3);
        }
        ...
        public void Eval_Json()
        {
            ...
            var res = EvaluationFunctions.eval(env, 0, false, "[[@Person.Age]]");
            //------------Assert Results-------------------------
           NUnit.Framework.Assert.AreEqual("22",CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_Json_Root()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual(expected.Replace(" ",""), CommonFunctions.evalResultToString(res).Replace(Environment.NewLine,"").Replace(" ",""));
        }
        ...
        public void Eval_JsonNested()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("dora", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_JsonNestedArray()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("Mary", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_JsonNestedArrayOfObjects()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("Mary,Jane", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_JsonArrayPrimitives()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("bob", CommonFunctions.evalResultToString(res));
        }
        [Test]
        [Author("Leon Rajindrapersadh")]
        [Category("Eval")]
        ...
        public void Eval_JsonArrayComplexStar()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("bob,bobe", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_JsonArrayComplexLast()
        {
            ...
            var res = EvaluationFunctions.eval(env, 0, false, "[[@arrayObj().Name]]");
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("bobe", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_JsonArrayComplex_ComplexExp()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("bobe bobe", CommonFunctions.evalResultToString(res));
        }
        ...
        public void Eval_JsonArrayComplex_Atom()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("1", CommonFunctions.evalResultToString(res));
        }

        [Test]
        [Author("Hagashen Naidu")]
        [Category("EvaluationFunctions_Eval")]
        public void EvaluationFunctions_Eval_WithEscapeCharsEscapeTrue_ShouldReturnEscapedString()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("C:\\test",CommonFunctions.evalResultToString(val));
        }
        ...
        public void EvaluationFunctions_Eval_WithEscapeCharsEscapeTrueRecordSet_ShouldReturnEscapedString()
        {
            ...
            //------------Assert Results-------------------------
            NUnit.Framework.Assert.AreEqual("C:\\temp", CommonFunctions.evalResultToString(val));
            NUnit.Framework.Assert.AreEqual("C:\\tval", CommonFunctions.evalResultToString(val2));
        }
